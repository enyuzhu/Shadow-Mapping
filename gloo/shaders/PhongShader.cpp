...
void PhongShader::SetTargetNode(const SceneNode& node,
  ...
  if (material_ptr->GetDiffuseTexture() != nullptr) {
    material_ptr->GetDiffuseTexture()->BindToUnit(0);
  ...
  // Bind ambient texture to texture unit 1
